...
///
/// Skeleton ships with a stub `solve_gaussian_coefficients` that only
/// populates the hardcoded row-4 classical E4 centered stencil and zero-fills
/// the remaining rows. The RBF+polynomial augmented solve is wired in 42.6b.
...
// Placeholder solver — 42.6a ships a zero-filled boundary block plus the
// hardcoded row-4 classical E4 centered first-derivative stencil.
// 42.6b replaces rows 0..3 with the solved Gaussian-RBF weights.
