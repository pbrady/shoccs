...
- [x] **40.4c** Persist three-way optimum to `known_values.json`:
  ...
  - **Carry-over for 40.5c:** same additive merge pattern applies to `footprint.*` entries. 40.4d will automate the regression test for this merge.
