...
- [ ] **45.6b.3** (original 45.6b, gated on 45.6b.1 + 45.6b.2) Add `TestRegressionBrady2DPareto` class to `tests/test_phs.py`, modeled on `TestRegressionBrady2DOptima` (lines 2020–2099 per agent finding #8):
