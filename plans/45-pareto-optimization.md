...
45.5a → 45.5a.1 → 45.5b                 # C++ validation + persist/validate ordering fix (review follow-up)
  ↓
45.6a.1 → 45.6a.1.1 → 45.6a.2 → 45.6b   # calibration (classical done) + _report_to_dict fix + tension + regression
  ↓
