...
- [x] **44.6d** Re-run calibration at `max_layer=6` with `--update-known-values` to restore layer4-6 data for E4_classical and E2_phs_k2:
  ...
  - Verified E4_classical and E2_phs_k2 have layer4, layer5, layer6 AND layer_bl42 data. Restored values match plan expectations exactly. ✓
  - File: `scripts/stencil_gen/sweeps/known_values.json`
  - Test: `cd scripts/stencil_gen && uv run pytest tests/test_phs.py -x -q -k "TestRegressionBrady2DCalibration"` — 2 passed ✓
